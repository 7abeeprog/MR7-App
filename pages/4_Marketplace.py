...
# --- 3. بناء واجهة React (طريقة الاستبدال الآمن لتجنب SyntaxError) ---
# لاحظ: لم نستخدم حرف f قبل علامات الاقتباس لكي لا يتدخل بايثون في الأقواس
react_html = """
<!DOCTYPE html>
<html dir="rtl">
<head>
                    ...
                    <nav className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6 glass p-6 rounded-[2rem] sticky top-0 z-50">
                        ...
                        <div className="flex-1 max-w-xl w-full relative text-black">
                            <input 
                                ...
                                className="w-full bg-white border border-white/10 rounded-2xl py-4 px-6 focus:border-yellow-500 outline-none transition-all font-bold text-sm"
...
# بدلاً من f-string المعقد، نستخدم التبديل البسيط لضمان عدم حدوث SyntaxError في بايثون
final_html = react_html.replace("LEADER_BALANCE_PLACEHOLDER", "1250000")
